...
import com.sanathbhardwaj.servicevalleydhanbad.Authentication.PhoneVerification;
...
//                            mDatabase.child("User IDs").child(uid).child("Customer").child("Name").setValue("sanath");
                            ...
                            mDatabase.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("user").addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                                    String password = getIntent().getStringExtra("password").trim();

                                    System.out.println(dataSnapshot.child("password").getValue().toString());;

                                    if (dataSnapshot.child("password").exists()){

                                        if (dataSnapshot.child("password").getValue().toString().trim().equals(password)){
                                        ...
                                        finish();
                                        Toast.makeText(OTP.this, "User not exits. Please register.", Toast.LENGTH_SHORT).show();
